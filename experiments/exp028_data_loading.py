...
def main() -> int:
    ...
    print("\n--- the answer ---")
    print("ONE ROUTE is closed for large language models, by arithmetic rather")
    print("than by engineering: the family that loads dense classical weights into")
    print("amplitudes and runs quantum linear algebra on them. Loading one weight")
    print("matrix costs more two-qubit gates than every gate this repository has")
    print("ever counted, and a 70B model is ~1e11 of them, at error rates that")
    print("would need to be ~1e-15 per gate to survive the depth.")
    print("\nThat is NOT a general 'no' for LLMs and quantum computing. It does not")
    print("exclude polynomial gains where classical compute is superlinear in the")
    print("data (loading an n x n matrix is n^2, matmul is ~n^2.37-n^3), methods")
    print("whose input is generated rather than read (row 2), or a small")
    print("combinatorially hard sub-problem. 'No known route' is not 'provably")
    print("impossible' -- that would need complexity separations nobody has.")
    print("\nThe OUTPUT side is the structural difference from chemistry: wanting")
    print("all n^2 numbers back classically costs n^2 again, while a ground-state")
    print("energy is one number and never pays it.")
